...
> Status: native-rescue software checks passing; hardware checks planned. Software
> tests do not authorize real writes. DAYU200 normal CLI authority and native rescue
> require separate real-device evidence.
